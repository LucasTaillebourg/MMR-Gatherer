 ...
 * 
 * @export
 * @interface MultiQueueMmr
 */
export interface MultiQueueMmr {
    /**
     * 
     * @type {Mmr}
     * @memberof MultiQueueMmr
     */
    ARAM?: Mmr;
    /**
     * 
...
/**
 * MmrResourceApi - axios parameter creator
 * @export
 */
export const MmrResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @summary getMmr
         ...
         * @throws {RequiredError}
         */
        getMmrUsingGET(summonerName: string, options: any = {}): RequestArgs {
            // verify required parameter 'summonerName' is not null or undefined
            if (summonerName === null || summonerName === undefined) {
                throw new RequiredError('summonerName','Required parameter summonerName was null or undefined when calling getMmrUsingGET.');
            }
            const localVarPath = `/mmr`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
            ...
            if (summonerName !== undefined) {
                localVarQueryParameter['summoner-name'] = summonerName;
            }
...
/**
 * MmrResourceApi - functional programming interface
 * @export
 */
export const MmrResourceApiFp = function(configuration?: Configuration) {
    return {
        /**
         * 
         * @summary getMmr
         ...
         * @throws {RequiredError}
         */
        getMmrUsingGET(summonerName: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<MultiQueueMmr> {
            const localVarAxiosArgs = MmrResourceApiAxiosParamCreator(configuration).getMmrUsingGET(summonerName, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
/**
 * MmrResourceApi - factory interface
 * @export
 */
export const MmrResourceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * 
         * @summary getMmr
         ...
         * @throws {RequiredError}
         */
        getMmrUsingGET(summonerName: string, options?: any) {
            return MmrResourceApiFp(configuration).getMmrUsingGET(summonerName, options)(axios, basePath);
        },
    };
};

/**
 * MmrResourceApi - object-oriented interface
 * @export
 * @class MmrResourceApi
 * @extends {BaseAPI}
 */
export class MmrResourceApi extends BaseAPI {
    /**
     * 
     * @summary getMmr
     * @param {string} summonerName summoner-name
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof MmrResourceApi
     */
    public getMmrUsingGET(summonerName: string, options?: any) {
        return MmrResourceApiFp(this.configuration).getMmrUsingGET(summonerName, options)(this.axios, this.basePath);
    }
